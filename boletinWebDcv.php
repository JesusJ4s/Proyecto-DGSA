...
<body class=" min-width-index">
    ...
    <div class="container-fluid text-center">
        <p class="display-6 bold-title">
            Dirección Control de Vectores, Reservorios y Fauna Nociva
        </p>
    </div>
    <!-- **************************************************************** -->
    <!-- Barra de navegación -->
    ...
    <main class="container-fluid row m-0 p-0">
        ...
        <!-- Primera sección -->
        <section class=" mt-5 col-8 d-flex justify-content-center" id="información Boletin">
            <!-- **************************************** -->
            <?php
                
                    echo $_SESSION['informacionEntera'];
        ...
        <aside class="col-3 mb-3">
            ...
            include("php/abrir_conexion.php");
                ...
                $Boletines = mysqli_query($conexion, "SELECT * FROM $tabla_db17 WHERE id_boletin_direccion = 4 AND boletin_visible = 1 ORDER BY RAND() LIMIT 10");

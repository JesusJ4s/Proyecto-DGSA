...
Login_JefCorrespondencia__Admin();
?>
...
<body class=" min-width-index color-fondo">
    ...
    <main class="contenedor-grid-index-horizontal">
        ...
        <div id="contenedor-total-total" class="">
            ...
            <div class="container-fluid text-center px-5 mx-0 mb-0 ocultar-div mb-5" id="parte1">
                ...
                <div class="border-radius-15 py-3 bg-blanco box-shadow-plano p-2">
                    ...
                    <div class="container-fluid text-center m-0 p-2">
                        ...
                        <div id="tabla_correspondencia_registro">
                            
                        </div>

                            
                        <!-- MODAL REGISTRO CORRESPONDENCIA -->
                        <div class="modal fade" id="modal_registro">
                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formCorrespondencia" method="POST" class="px-2 pt-2">
                                            <div class="px-3">
                                                                ...
                                                                <tr>
                                                                    <td class="col-2">
                                                                        <div class=" formulario__grupo" id="grupo__nroOficio"><input
                                                                                ...
                                                                                required id="nroOficio" name="nroOficio" min="0"></div>
                                                                    </td>
                                                                    ...
                                                                    <td class="col-2">
                                                                        ...
                                                                        <div class="">
                                                                            <div class=" formulario__grupo" id="grupo__rif_empresa"><input
                                                                                class="form-control  formulario__input" type="number"
                                                                                required id="rif_empresa" name="rif_empresa" onblur="empresas_fun();" min="0">
                                                                            </div>
                                                                            <p id="letra_registro" class="ocultar-div text-primary bold">¿Desea registrar?</p>
                                                                        </div>
                                                                    </td>
                                            ...
                                            <!-- MODAL FORMULARIO NUEVA EMPRESA -->
                                            <!-- TODO: FORMUALRIO DE REGISTRO DE LA EMPRESA -->
                                            <!-- Modal para mostrar información-->
                                            <div class="modal fade" id="registroEmpresaM" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" id="registroEmpresaMC">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <label class="formulario__label">Rif</label>
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <select class="form-select" id="identificador2" name="identificador2">
                                                                                <option value="V">V-</option>
                                                                                <option value="E">E-</option>
                                                                                <option value="J">J-</option>
                                                                                <option value="G">G-</option>
                                                                        ...
                                                                        <div class="col-6" id="registrar">
                                                                            <div class="formulario__grupo" id="grupo__rif_empresa_regis">
                                                                                <input class="form-control formulario__input" id="rif_empresa_regis" name="rif_empresa_regis" min="0">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div id="registration-form" class="col-12">
                                                                    <div class="row">
                                                                        <div class="col-auto">
            ...
            <!-- DIV EMPRESAS DEL SISTEMA -->
            <div class="container-fluid text-center px-5 mx-0 mb-0 ocultar-div mb-5" id="parte4">
                <div class="border-radius-15 py-3 bg-blanco box-shadow-plano p-2">
                    <div class="container-fluid text-center m-0 p-2 bg-blanco border-radius-15 row">
                        <div class="col-auto">
                            <h2 class="pt-3">Empresas</h2>
                        </div>
                       
                        <div id="tabla_empresas_corr">
    ...
    <script src="../js/correspondencia_verify.js"></script>

    <!-- PROXIMO A BORRAR TODO: -->

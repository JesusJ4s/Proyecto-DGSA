    ...
    <main class="container-fluid row m-0 p-0">
        ...
        <aside class="col-3 mb-3">
            ...
            include("php/abrir_conexion.php");
                ...
                $Boletines = mysqli_query($conexion, "SELECT * FROM $tabla_db17 WHERE id_boletin_direccion = 2 AND boletin_visible = 1 ORDER BY RAND() LIMIT 10");

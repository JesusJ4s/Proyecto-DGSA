...
$Division = $_POST['division_select'];

$resultados = "SELECT * FROM $tabla_db6 i INNER JOIN $tabla_db1 u ON i.ing_encar_inv_id = u.id_usuario INNER JOIN $tabla_db5 d ON i.direccion_inv_id = d.id_direcciones INNER JOIN $tabla_db3 e ON i.dpto_inv_id = e.id_departamento WHERE division_inv_id = '$Division'";
...
$pdf->Output('I', 'Reporte División.pdf', true);
?>
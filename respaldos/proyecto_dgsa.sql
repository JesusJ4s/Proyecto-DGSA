...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-09-2026 a las 01:55:22
...
(1, 1, 'Jesus', 'Castillo', 'V', '27146430', 'JADMIN', '04124457287', '', 'jesusgole33@gmail.com', 21, 11, 1, 1, '$2y$10$/dCmB5PZQFciGSDieeRpduuRs1Y5LcOQ/6w8mV8ZhU/kX6zdcuudS', 1, '$2y$10$pGlUWxUuE4FtG22/ox7YJOKfKyUw9LZnKJcqDvVVxgEAEpEBsMij2', 2, '$2y$10$zNvk/aDVSrKDKEOcCcZkmOdfAzkANKYbjlfiW2.ZH1pJzt7kWEIui', 3, '$2y$10$59Yc0JuZDdyxa7fGEcc89uyXq8YZQ2ijTiIAksUCCua6mmicc4BG2', '0303', 1),
...
(1, 'Imagen', '2024-11-13 19:19:09'),
(2, 'Video', '2024-11-13 19:19:09'),
(3, 'Documento', '2024-11-13 19:19:09');
...
CREATE TABLE `e4_boletines` (
  ...
  `titulo_boletin` varchar(150) NOT NULL,
  `img1_boletin` varchar(255) NOT NULL,
  `text1_boletin` mediumtext NOT NULL,
  `img2_boletin` varchar(255) DEFAULT NULL,
  `text2_boletin` mediumtext DEFAULT NULL,
  `imgvid3_boletin` varchar(255) DEFAULT NULL,
  `text3_boletin` mediumtext DEFAULT NULL,
...
CREATE TABLE `e5_instrumentos_legales` (
  ...
  `titulo_instrumento` varchar(100) NOT NULL,
...
CREATE TABLE `e6_tipos_instrumentos` (
  ...
  `nombre_tipo_instrumento` varchar(45) NOT NULL,
...
CREATE TABLE `e7_grupos_instrumentos` (
  ...
  `nombre_grup_instrumento` varchar(150) NOT NULL,
...
CREATE TABLE `f1_coordinaciones_web` (
  ...
  `imagen_coord1` varchar(255) NOT NULL,
  `titulo_text1` varchar(255) NOT NULL,
  `descripcion_text1` mediumtext NOT NULL,
  `imagen_coord2` varchar(255) DEFAULT NULL,
  `titulo_text2` varchar(255) DEFAULT NULL,
  `descripcion_text2` mediumtext DEFAULT NULL,
  `imagen_coord3` varchar(255) DEFAULT NULL,
  `titulo_text3` varchar(255) DEFAULT NULL,
  `descripcion_text3` mediumtext DEFAULT NULL,
  `titulo_lista1` varchar(255) DEFAULT NULL,
  `lista1_coord` mediumtext DEFAULT NULL,
  `titulo_lista2` varchar(255) DEFAULT NULL,
  `lista2_coord` mediumtext DEFAULT NULL,
...
(11, 1, 3, '27146430', '2024-11-13 15:19:34', 'Ingreso del Usuario: Jesus Castillo.'),
(12, 1, 4, '27146430', '2024-11-13 15:23:04', 'Salida del sistema del Usuario: Jesus Castillo.'),
(13, 1, 3, '27146430', '2024-11-14 14:42:45', 'Ingreso del Usuario: Jesus Castillo.'),
(14, 1, 4, '27146430', '2024-11-14 14:43:18', 'Salida del sistema del Usuario: Jesus Castillo.'),
(15, 1, 3, '27146430', '2024-11-22 17:39:04', 'Ingreso del Usuario: Jesus Castillo.'),
(16, 1, 4, '27146430', '2024-11-22 17:44:31', 'Salida del sistema del Usuario: Jesus Castillo.'),
(17, 1, 3, '27146430', '2024-11-22 18:19:13', 'Ingreso del Usuario: Jesus Castillo.'),
(18, 1, 4, '27146430', '2024-11-22 18:24:13', 'Salida del sistema del Usuario: Jesus Castillo.'),
(19, 1, 3, '27146430', '2024-11-22 18:24:21', 'Ingreso del Usuario: Jesus Castillo.'),
(20, 1, 4, '27146430', '2024-11-22 18:26:21', 'Salida del sistema del Usuario: Jesus Castillo.'),
(21, 1, 3, '27146430', '2024-12-13 17:44:27', 'Ingreso del Usuario: Jesus Castillo.'),
(22, 1, 4, '27146430', '2024-12-13 17:45:30', 'Salida del sistema del Usuario: Jesus Castillo.'),
(23, 1, 3, '27146430', '2025-01-02 16:03:09', 'Ingreso del Usuario: Jesus Castillo.'),
(24, 1, 4, '27146430', '2025-01-02 16:09:01', 'Salida del sistema del Usuario: Jesus Castillo.'),
(25, 1, 3, '27146430', '2025-01-02 17:38:33', 'Ingreso del Usuario: Jesus Castillo.'),
(26, 1, 4, '27146430', '2025-01-02 17:39:07', 'Salida del sistema del Usuario: Jesus Castillo.'),
(29, 1, 3, '27146430', '2026-08-31 19:50:42', 'Ingreso del Usuario: Jesus Castillo.'),
(30, 1, 2, '27146430', '2026-08-31 19:51:36', 'El usuario: Jesus Castillo realizó cambios en sus datos: Respuesta 1 cambió. Respuesta 2 cambió. Respuesta 3 cambió. Cambios realizados.');
...
--
ALTER TABLE `z1_historial_camb_sis`
  MODIFY `id_historial_cambios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `Jesus27146430` ON SCHEDULE AT '2026-08-31 19:58:22' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
                UPDATE a1_usuarios SET sesion = '0' WHERE id_usuario = '1';
                INSERT INTO z1_historial_camb_sis (id_historial_cambios, id_usuario_cambio, id_accion_cambio, entidad_cambio, fecha_usuario_cambio, descripcion_cambio) values (NULL, '1', '4', '27146430', now(), 'Salida automática del sistema, del Usuario: .');
            END$$

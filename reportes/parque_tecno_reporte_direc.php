...
$Direccion = $_POST['direccion_select'];

$resultados = "SELECT * FROM $tabla_db6 i INNER JOIN $tabla_db1 u ON i.ing_encar_inv_id = u.id_usuario INNER JOIN $tabla_db5 d ON i.direccion_inv_id = d.id_direcciones INNER JOIN $tabla_db3 e ON i.dpto_inv_id = e.id_departamento WHERE direccion_inv_id = '$Direccion'";
...
$pdf->cell(70,4, $row['nombre_dire'], 'B', 0,'C',0);
$pdf->cell(5,4, '', 0, 0,'C',0); //ESPACIADO
$pdf->cell(23,4, 'DEPARTAMENTO ', 0, 0,'S',0);
$pdf->cell(38,4, $row['nombre_dpto'], 'B', 1,'C',0);
$pdf->Ln(6);
$pdf->SetX(23);
...
$pdf->Output('I', 'Reporte Direccion.pdf', true);
?>
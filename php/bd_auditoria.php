<?php
include("verificacion_login.php");
LoginAdmin();
/**
...
if ($_SESSION['logged_in'] == true) {
    ...
    exportarTablas("localhost", "root", "", "proyecto_dgsa");
    // AUDITORIA *****************************************************************
    ...
    $fecha = date("Y-m-d");
    $descripcion_Cambio = "Nuevo respaldo de la base de datos creado en fecha: " . $fecha . ". Creado por el usuario: " . $valorNombre . ".";
    $accionHecha = "17";
    ...
    // FINAL AUDITORIA ************************************************************
// Ejemplo de respuesta para la llamada AJAX
    echo "<b>Copia de Seguridad: </b>Copia de seguridad de la base de datos hecha de manera correcta, puede consultarla en la carpeta <i>Respaldos</i>, del sistema.";
}
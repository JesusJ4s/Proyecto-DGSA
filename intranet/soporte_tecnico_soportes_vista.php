...
<body class="min-width-index">
  ...
  <div class="modal fade" id="Info_Vistas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
  ...
  <div class="container-fluid border my-2 px-0" id="centro-id">
    <div class="w-85 mx-auto px-2 my-3">
      ...
      <div class="d-flex flex-row-reverse">
        <a href="soporte_tecnico.php" class="btn btn-danger me-1 botones-solicitud"><img

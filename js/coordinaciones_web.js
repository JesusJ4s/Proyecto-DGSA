...
function coordinacionButton(button){
    ...
    var parametros = 
    {
        'id_coordiWeb': valorInput,
        'id_direcInput': valorInputAnterior,
        'identificador': 'verCoordinaciones'
    }

    // alert(valorInput+' '+valorInputAnterior)
    $.ajax({
      data: parametros,
      url: './php/coordinaciones_web.php',
      type: 'POST',      
      // Mensaje cuando ya cargó
      success: function(mensaje)
      {
        var pagina = mensaje;
        window.open('coordinaciones_'+pagina+'.php', '_blank');
        // alert(mensaje)
      },
...
// ******************************
function Coordinacion(Valor){

    var identificador = 
    {
        "validador": Valor,
        "identificador": "cargarCoordinacion"
    }
    $.ajax({
        type:"POST",
        url:"./php/coordinaciones_web.php",

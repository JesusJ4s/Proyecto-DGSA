...
<body class=" min-width-index">
    ...
    <nav class="ms-5 me-5">
            ...
            <a class="list-group-item list-group-item-action bg-azul-claro-cromatico5" href="#DEA_Medicamentos">Medicamentos</a>
            <a class="list-group-item list-group-item-action bg-azul-claro-cromatico5" href="#DEA_chagas">Chagas-Epidemiologia</a>
            <a class="list-group-item list-group-item-action bg-azul-claro-cromatico5" href="#DEA_chagas2">Chagas-Control de Vectores</a>
            <a class="list-group-item list-group-item-action bg-azul-claro-cromatico5" href="#Parasitosis">Parasitosis</a>

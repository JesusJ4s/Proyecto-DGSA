...
<body class=" min-width-index">
    ...
    <div class="modal fade" id="RegistroCorres" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-bs-backdrop="static">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        <b>Empresas</b>: Con el rif de la empresa puede cargar los datos ya registrados, de lo contrario llenelos de manera manual y se registrará la empresa para agilizar el proceso a futuro. 
                    </p>
                    <p>
    ...
    <div class="modal fade" id="mi-modal-ayuda2" >
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Aquí puede visualizar todas las correspondencias que ha registrado, puede usar la barra de búsqueda para encontrar una solicitud específica.
                        <br>
                        Si el campo de estatus está en <span class="bg-warning">-amarillo-</span>, significa que no ha sido aceptada por el receptor. Si está en <span class="bg-success">-verde-</span>, significa que ya confirmo la llegada de los documentos.
                    </p>
                ...
                <div class="container-fluid text-center mx-2  p-2 bg-blanco border-radius-15">
                    <form id="formCorrespondencia" method="POST" class="px-5 pt-2 row">
                            ...
                            <div class="text-center row my-3 bg-blanco-hsl p-3 border-radius-15">
                                ...
                                <div class="col-12">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="col-2"><div class=" formulario__grupo" id="grupo__nroOficio"><input class="form-control  formulario__input" type="number" required id="nroOficio" name="nroOficio"></div></td>

                                                <td class="col-1"><div class=" formulario__grupo" id="grupo__fecha_salida"><input class="form-control  formulario__input" type="date" required id="fecha_salida" name="fecha_salida"  oninput="this.value = validarFecha(this.value)"></div></td>

                                                <td class="col-2"><div class=" formulario__grupo" id="grupo__procedencia"><input class="form-control  formulario__input" type="text" readonly disabled value="" id="procedencia" name="procedencia"></div></td>

                                                <td class=""><div class=" formulario__grupo" id="grupo__asunto"><input class="form-control  formulario__input" type="text" required id="asunto" name="asunto"></div></td>

                                                <td class="col-1"><input class="form-control" type="number" id="contador" disabled readonly></td>

                                                <td class="col-1"><div class=" formulario__grupo" id="grupo__fecha_llegada"><input class="form-control  formulario__input" type="date" required id="fecha_llegada" name="fecha_llegada" oninput="this.value = validarFecha(this.value)"></div></td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="col-12 row">
                                    ...
                                    <div class="col-3">                                       
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <select class="form-select" id="identificador" name="identificador" onchange="empresas_fun();">
                                            ...
                                            <div class="col-7" id="registrado">
                                                <div class="formulario__grupo" id="grupo__rif_empresa">
                                                    <input class="form-control formulario__input" id="rif_empresa" name="rif_empresa" required onkeyup="empresas_fun();">
                                                </div>
                                            </div>
                                            <div class="col-7 ocultar-div" id="registrar">
                                                <div class="formulario__grupo" id="grupo__rif_empresa_regis">
                                                    <input class="form-control formulario__input" id="rif_empresa_regis" name="rif_empresa_regis">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <div class="form-group formulario__grupo" id="grupo__nombre_emp">
                                                    ...
                                                    <input class="form-control formulario__input" type="text" id="nombre_emp" name="nombre_emp">
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <div class="form-group formulario__grupo" id="grupo__dedicacion">
                                                    <label class="formulario__label">Dedicacion Empresa</label>
                                                    <input class="form-control formulario__input" type="text" id="dedicacion" name="dedicacion">
                                                </div>
                                            </div>
                                            <div class="col-auto d-flex align-items-end mb-1">
                                                <button type="button" class="btn btn-secondary " id="regisEmpresa" name="regisEmpresa">Registrar</button>
                                            </div>
                                        </div>                                   
                                    </div>
                                </div>
                        ...
                        <div class="text-start">
                            <button type="button" class="btn btn-success" id="corres_registro_btn" name="corres_registro_btn">Enviar</button>

                        </div>

                        <input type="hidden" id="correspondencia" readonly name="correspondencia" value="registroCorres">

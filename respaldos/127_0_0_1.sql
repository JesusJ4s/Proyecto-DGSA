...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-09-2023 a las 05:23:34
...
(212, 1, 7, '2023-09-17 23:22:54', 'Nuevo respaldo de la base de datos creado en fecha: 2023-09-17. Creado por el usuario: Jesus Castillo.'),
(213, 1, 6, '2023-09-17 23:22:58', 'Salida del sistema del Usuario: Jesus Castillo.');
...
--
ALTER TABLE `c1_inventario_equipo`
  MODIFY `id_case` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `c3_solicitudes_soportes`
  MODIFY `id_soporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `d1_correspondencia`
  MODIFY `id_nro_admision` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `z1_historial_camb_sis`
  MODIFY `id_historial_cambios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=214;

...
<body class=" min-width-index">
    ...
    <nav class="ms-5 me-5">
            ...
            <a class="list-group-item list-group-item-action bg-azul-claro-cromatico5" href="#DEA_sala">Sala Situacional</a>
 ...
 <!-- **************************************************************************************************************** -->
   ...
   <div class="container-fluid ps-4 mt-5">
            <h1 id="DEA_sala" class="my-5 ms-5"></h1>
            <div class="text-center">
                <div class="card bg-light wh-doc mx-2 d-inline-block">
                    <div class="card-body border-css">
                        <embed src="assets/documentos/DEA/sala situacional/Sala Situacional WEB_1.pdf" type="application/pdf" class="pdf_mini">
                        <h6 class="card-title">Sala Situacional y Estadística Epidemiológica Ambiental</h6>
                        <a target="_blank" id="lib_dcvfn" class="btn btn-outline-primary" href="assets/documentos/DEA/sala situacional/Sala Situacional WEB_1.pdf" type="application/pdf">Leer</a>
                    </div>
                </div>
            </div>
    </div>

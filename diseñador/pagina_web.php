                    ...
                    <form id="form_Modificaciones" method="POST">
                        <div class="container-fluid row">
                            <div class="col-6 mb-3">
                                ...
                                <input id="nombre_dire" name="nombre_dire" class="form-control mb-3" disabled>
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcionR" class="form-control mb-3" placeholder="Escriba una descripción para la imagen o video si así lo desea. Solo letras, espacios, números, guión y guión bajo.">
    ...
    <main class="">
        <div class="container-fluid mt-5 mb-4 py-2  border-radius-15">
            <div class="w-95 mx-auto bg-blanco px-3 box-shadow-plano border-radius-15">
                <div class="ms-3">
                    <a href="../intranet/index_intranet.php" class="d-inline text-dark enlaces_limpios2"><u>Inicio</u></a>
                </div>
                <div class="d-flex flex-row-reverse">
                    ...
                    <a href="../intranet/index_intranet.php" class="btn btn-primary mx-0 me-1 botones-solicitud"><img
                ...
                <div class="bg-barra-boton">
                    ...
                    <div class="border mt-3" id="parte1">
                        <div>
                            <h3 class="m-0 py-4 ps-2 bg-blanco">Subir Nueva Imagen o Video</h3>
                        </div>
                        <hr class="m-0">
                        <!-- FORMULARIO -->
                        <form class="m-0" method="post"id="formulario_galeria" action="" enctype="multipart/form-data">
                                ...
                                <div class="col-2">
                                    ...
                                    <div class="toast position-absolute bg-secondary" role="alert" aria-live="assertive"
                                        ...
                                        <div class="toast-body text-white">
                                            Busque dentro de su equipo, la imagen o video que utilizará que utilizará.
                                        </div>
                                    </div>
                                </div>
                                <div class="col-9">
                                    <label>Imagen o Video
                                        <input class="form-control" type="file" id="archivo_subir"  name="archivo_subir">
                                    </label>
                            ...
                            <div class="m-0 row bg-blanco py-2">
                                ...
                                <div class="col-9 ">
                                    ...
                                    <div>
                                        <textarea class="bg-blanco-hsl" id="descripcion" name="descripcion" minlength="0"
                    ...
                    <div class="accordion" id="Visualizador_acc">
                        ...
                        <div class="px-2">
                            ...
                            <div class="my-3 text-start">
                                ...
                                <!-- <button class="btn btn-outline-primary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#Videos_acc" aria-expanded="true"
                                    aria-controls="Videos_acc">
                                    <b>Videos</b>
                                </button> -->
                            </div>
                            ...
                            <!-- <div class="accordion-collapse collapse" id="Videos_acc"
                                aria-labelledby="headingOne" data-bs-parent="#Visualizador_acc">
                                <div class="accordion-body" aria-expanded="true">
                                    <h3 class="text-center p-2 mb-3">Videos Subidas a la Web</h3>
                                    <div id="mostrar_videos_web" class="bg-blanco p-2 border-radius-15">
